...
import 'package:fixhome2/Models/exception.dart';
...
class _MyRegisterState extends State<MyRegister> {
  ...
  void showDialogue(context, child) {
    showDialog(
        context: context,
  ...
  Future<void> getLocation() async {
    ...
    if (permission == LocationPermission.denied) {
      if (permission == LocationPermission.denied) {
        throw HandleDeniedAccessError('Location permissions are denied');
      }
    }

    if (permission == LocationPermission.deniedForever) {
      throw HandleDeniedAccessError(
  ...
  Future<void> insertData(
    ...
    if (userCredential.user.email != null) {
      FirebaseFirestore.instance.collection("users").doc(userCredential.user.uid).set({
        ...
        showDialogue(context, const Text("Failed to Add User"));
      });
    }
  }
