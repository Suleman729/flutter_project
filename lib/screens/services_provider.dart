                  ...
                  child: InkWell(
                    onTap: (){
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  Single(name: list[index]['name'], image: list[index]['image'], cnic: list[index]['cnic'], email: list[index]['email'], contact: list[index]['contact'], serviceName: list[index]['service_name'],)));
                    },
                    child: Card(
                      child: Padding(
